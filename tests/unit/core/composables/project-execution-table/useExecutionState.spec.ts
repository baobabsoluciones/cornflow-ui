...
const mockT = vi.fn((key: string) => {
  const translations: Record<string, string> = {
    ...
    'executionTable.unknownTooltip': 'Unknown',
    'executionTable.pending': 'Pending',
    'executionTable.running': 'Running',
    'executionTable.completed': 'Completed',
    'executionTable.failed': 'Failed',
    'executionTable.pend': 'PEND',
    'executionTable.run': 'RUN',
    'executionTable.comp': 'COMP',
    'executionTable.fail': 'FAIL',
    'executionTable.optimal': 'Optimal',
    'executionTable.feasible': 'Feasible',
    'executionTable.infeasible': 'Infeasible',
    'executionTable.opt': 'OPT',
    'executionTable.feas': 'FEAS',
    'executionTable.infeas': 'INFEAS',
    'executionTable.optimalTooltip': 'Optimal',
    'executionTable.feasibleTooltip': 'Feasible',
    'executionTable.infeasibleTooltip': 'Infeasible',
  }
  ...
  appConfig: {
    parameters: {
      solutionStates: {
        '0': {
          color: 'green',
          messageKey: 'executionTable.optimal',
          codeKey: 'executionTable.opt',
        },
        '1': {
          color: 'yellow',
          messageKey: 'executionTable.feasible',
          codeKey: 'executionTable.feas',
        },
        '2': {
          color: 'red',
          messageKey: 'executionTable.infeasible',
          codeKey: 'executionTable.infeas',
        },
      },
      executionStates: {
        '0': {
          color: 'grey',
          messageKey: 'executionTable.pending',
          codeKey: 'executionTable.pend',
        },
        '1': {
          color: 'blue',
          messageKey: 'executionTable.running',
          codeKey: 'executionTable.run',
        },
        '2': {
          color: 'green',
          messageKey: 'executionTable.completed',
          codeKey: 'executionTable.comp',
        },
        '3': {
          color: 'red',
          messageKey: 'executionTable.failed',
          codeKey: 'executionTable.fail',
        },
      },
    },
  },
    ...
    test('should maintain reactivity when store changes', () => {
      ...
      if (mockGeneralStore.appConfig?.parameters?.executionStates) {
        mockGeneralStore.appConfig.parameters.executionStates['0'] = {
          color: 'purple',
          messageKey: 'executionTable.updated',
          codeKey: 'executionTable.upd',
        }
